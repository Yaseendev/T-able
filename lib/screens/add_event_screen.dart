...
class _AddEventScreenState extends State<AddEventScreen> {
   insert(title, startTime, endTime) {
    var _clientID = new ClientId("921123218509-vkfpjduam1m89v38j5np4mdcduet9m0b.apps.googleusercontent.com","");
    clientViaUserConsent(_clientID, CalendarClient._scopes, prompt).then((AuthClient client) {
      var calendar = googleCalendar.CalendarApi(client);
      calendar.calendarList.list().then((value) => print("VAL________${value.etag}"));
